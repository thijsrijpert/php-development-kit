 ...
 *
 * <p>All general-purpose {@code ICollection} implementation classes (which
 * typically implement {@code ICollection} indirectly through one of its
 * subinterfaces) should provide two "standard" constructors: a void (no
 * arguments) constructor, which creates an empty collection, and a
 * constructor with a single argument of type {@code ICollection}, which
 * creates a new collection with the same elements as its argument.  In
 * effect, the latter constructor allows the user to copy any collection,
 * producing an equivalent collection of the desired implementation type.
 * There is no way to enforce this convention (as interfaces cannot contain
 * constructors) but all of the general-purpose {@code ICollection}
 ...
 * <i>not</i> be construed to imply that invoking {@code ICollection.contains}
 ...
 * a serializable {@code ICollection<E>}, where {@code E} does not implement the
 ...
 * synchronization protocol.  If a {@code ICollection} implementation has a
...
interface ICollection extends IIterable, ArrayAccess {
     ...
     * guarantee).
     *
     * @return Iterator {@code Iterator} over the elements in this collection
     */
